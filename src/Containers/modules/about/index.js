        ...
        <React.Fragment>
            <div className="space-x-40">
                <div className="flex flex-row justify-around m-20">
                    <motion.div className="flex flex-col space-x-6 p-4  rounded-lg" style={{ background: "#99ebfa" }}
                        initial={{ scale: 0 }}
                    ...
                    >
                        ...
                        <span className="text-4xl text-blue-500" > I am Rohith Reddy Mandala. _</span>
                        <span className="text-2xl">i'm a Student, Developer, artist and</span>
                        <span className="text-4xl">Founder of WOLF</span>
                        <span className="text-xl flex">any enquire: <p className="text-2xl text-red-500">rohith.mandala@outlook.</p></span>
                    </motion.div>
                    <motion.div className="text-5xl p-6"
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 503 503" height="100" viewBox="0 0 503 503" width="100"><g>
                            <circle cx="286.983" cy="189.5" fill="#99ebfa" r="179.5" />
